export default {
    ...
    torrent_parser_qbittorrent_send: 'Download via qBittorrent',
    torrent_parser_qbittorrent_descr: 'Send torrent to qBittorrent with first/last piece priority',
    settings_qbittorrent_url: 'Web UI URL',
    settings_qbittorrent_url_descr: 'qBittorrent Web UI address with port',
    settings_qbittorrent_test: 'Test connection',
    qbittorrent_no_url: 'Please set qBittorrent URL in settings first',
    qbittorrent_testing: 'Connecting to qBittorrent...',
    qbittorrent_test_ok: 'qBittorrent: connection OK',
    qbittorrent_test_fail: 'qBittorrent: connection failed',
    qbittorrent_sending: 'Sending torrent to qBittorrent...',
    qbittorrent_sent: 'Torrent sent to qBittorrent',
    qbittorrent_error: 'qBittorrent: send failed',
    ...
    downloads_empty: 'Empty',
    downloads_error: 'Error',
    downloads_unconfigured_title: 'qBittorrent not configured',
    downloads_unconfigured_descr: 'Open Settings → qBittorrent and set the server URL',
    downloads_folder: 'Folder',
    downloads_file: 'File',
    downloads_delete_title: 'Delete «%s»?',
    downloads_delete_torrent_title: 'Delete entire torrent?',
    downloads_delete_torrent_subtitle: 'File is part of a multi-file torrent. qBit will remove the whole torrent',
    downloads_delete_folder_title: 'Delete folder «%s»?',
    downloads_delete_folder_subtitle: 'Folder contains torrent «%s» — it will be removed via qBit together with the folder',
    downloads_delete: 'Delete',
    downloads_delete_confirm: 'Yes, delete',
    downloads_deleted: 'Deleted',
    downloads_delete_error: 'Deletion error',
    downloads_pause: 'Pause download',
    downloads_resume: 'Resume download',
    downloads_pause_torrent_descr: 'Stop seeding/downloading this whole torrent',
    downloads_pause_file_descr: 'Pause only this single file inside the torrent',
    downloads_paused: 'Paused',
    downloads_resumed: 'Resumed',
    downloads_toggle_error: 'Error',
    settings_qbittorrent_delete_token: 'Delete token',
    settings_qbittorrent_delete_token_descr: 'X-Delete-Token from nginx.conf of qBit proxy (for WebDAV DELETE)',
    title_last: 'Last',
    title_action: 'Action',
